...
class _HomeScreenState extends State<HomeScreen> {
  ...
  final List<Metier> metierList = [
    ...
    Metier('assets/images/menage.jpeg', 'Menage', 4.9, 'Paris', 'Professionnel',
        'Mark Marker', false),
    Metier('assets/images/img_5.png', 'Plombier', 4.9, 'Paris', 'Professionnel',
        'Mark Marker', false),
    Metier('assets/images/img_11.png', 'Menage', 4.9, 'Paris', 'Professionnel',
        'Mark Marker', false),
  ];
  final List<Demande> demandeList = [
    ...
    Demande(
      ...
      '20€ - 40€',
      'Vendredi 30 décembre 2022 de 12:30 à 13:30',
      Metier('assets/images/menage.jpeg', 'Menage', 4.9, 'Paris',
          'Professionnel', 'Nourhene Bakalti', false),
    ),
    Demande(
      ...
      '20€ - 40€',
      'Vendredi 30 décembre 2022 de 12:30 à 13:30',
      Metier('assets/images/img_5.png', 'Plombier', 4.9, 'Paris',
          'Professionnel', 'Nourhene Bakalti', false),
    ),
  ];
              ...
              Positioned(
                ...
                child: GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      shape: BoxShape.circle,
                      color: metier.isDisliked ? Colors.white : Colors.white,
                      // La couleur de fond est la même pour les deux états
                      border: Border.all(
                    ...
                    child: Center(
                      child: Icon(
                        metier.isDisliked
                            ...
                            : Icons.favorite,
                        color: metier.isDisliked ? Colors.red : Colors.red,
...
class Demande {
  ...
  Demande(this.imagePath, this.serviceName, this.location, this.priceRange,
      this.date, this.metier,
      {this.isDisliked = false, this.verified = false});
}
...
class Offre {
  ...
  Offre(this.imagePath, this.offreName, this.location, this.prix, this.desc,
      this.metier,
      {this.isDisliked = false});
}
